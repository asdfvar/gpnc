...
Defining $F_0 (N)$ to be the number of adds/multiplies of the DFT of $N$ points:
%
\begin {equation} \label {eq:F0}
F_0 (N) := 2 N^2 - N
\end {equation}
%
and if $F_1(N)$ is the first "decimation" of the DFT, then there will be $2 F_0(N/2)$ smaller DFT's followed by $N/2$ adds and $N$ multiplies ($3/2 N$ add/multiplies), or
%
...
\begin {aligned}
F_\alpha (N) &= 2 F_{\alpha - 1} (N/2) + 3/2 N
\end {aligned}
\end {equation}
%
...
F_\alpha (N) &= N^2/2^{\alpha - 1} - N + 3/2 \alpha N
\end {aligned}
\end {equation}
%
